console.info("pages/viewer_img/viewer_img onInit");
...
export default {
  ...
  openPath() {
    this.fileName = $app.getImports().memory.paths[$app.getImports().memory.paths.length - 1].split("/").pop();
    ...
    const imgDir = "internal://app\\..\\../run/" + $app.getImports().bundleName.bundleName + "/assets/js/default/viewer_img";

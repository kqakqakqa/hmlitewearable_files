console.info("pages/viewer_script_warnings/viewer_script_warnings onInit");

const warningTexts = [
  "你正在运行JavaScript。",
  "JavaScript可以访问和修改文件。",
  "JavaScript可能对数据、程序、甚至系统造成不可逆的影响。",
  "本程序不对JavaScript的内容负责。",
  "如果你不清楚这个JavaScript的作用，请不要继续！",
];
...
export default {
  ...
  onContinueSwipe(data) {
    if (data.direction === "right" && this.scriptWarningFinished) return $app.getImports().router.replace({ uri: "pages/viewer_script/viewer_script" });
  },
  onGoBackClick() {
